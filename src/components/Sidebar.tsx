import { BookOpen, Users, Info, MapPin, X, ListPlus } from "lucide-react";
...
export function Sidebar({ isOpen, onClose, activeSection, onNavigate }: SidebarProps) {
  ...
  const menuItems = [
    ...
    {id:'abbreviations', label: 'Abreviaturas', icon: ListPlus},
    { id: 'credits', label: 'Equipo de trabajo', icon: Users },
    ...
    <>
      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <div className={`p-6 border-t border-gray-100 bg-gray-50 ${isOpen ? "block": "hidden"}`}>
